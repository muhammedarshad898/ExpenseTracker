...
export default function DashboardPage() {
  // Use the correct type for transactions
  ...
  return (
    <DashboardLayout>
      ...
      <div className="flex justify-end mb-6">
        ...
        <button
          className="flex items-center text-red-600 hover:text-red-800 ms-3"
        ...
        <div className="bg-white p-6 rounded-xl shadow-md">
          ...
          <ul className="space-y-3 text-sm text-gray-600">
            {transactions.map((item) => (
              <li className="flex justify-between items-center border-b pb-2" key={item._id}>
                ...
                <div className="flex space-x-2">
                  {/* Edit Button */}
                  <EditTransactionModal Transactions={item} />
